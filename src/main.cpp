...
const string strMessage909Coin = "909Coin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfWork())
    {
        ...
        if (0 && vtx[0].GetValueOut() > nReward )
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // 909Coin: check proof-of-stake block signature
...
// 909Coin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "909Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 000005da1422f4d69385325e57643b07616abd3d89242c36c87c253d58582278
        //block.hashMerkleRoot == 2011634c12c99ada95475a06a9bcce2c845b75a720f6cd3b1478a71de3ab6312
        //block.nTime =  1560748704
        //block.nNonce = 100628

        const char* pszTimestamp = "909Coin for world economy 2019";
        CTransaction txNew;
        txNew.nTime = 1560748704;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 100628 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x2011634c12c99ada95475a06a9bcce2c845b75a720f6cd3b1478a71de3ab6312"));
...
unsigned char pchMessageStart[4] = { 0xcb, 0xc1, 0xbb, 0xa2 };
